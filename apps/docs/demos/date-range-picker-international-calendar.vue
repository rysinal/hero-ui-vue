<template>
  <!--
    Vue has no I18nProvider: the locale is passed straight to DateRangePicker,
    which forwards it to the field segments, and to the RangeCalendar it hosts.
  -->
  <DateRangePicker
  ...
  >
    ...
    <DateRangePicker.Popover>
      <RangeCalendar aria-label="Trip dates" locale="hi-IN-u-ca-indian">
...
const defaultValue = { end: start.add({ days: 7 }), start }
</script>
